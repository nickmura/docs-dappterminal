...
- **`src/app/api/README.md`** - API routes reference
- **`src/plugins/README.md`** - Plugin development guide
- **`src/plugins/wormhole/ARCHITECTURE.md`** - Wormhole integration
- **`src/plugins/stargate/ARCHITECTURE.md`** - Stargate integration
