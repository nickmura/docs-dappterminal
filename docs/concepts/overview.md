...
sidebar_position: 1
title: Overview
description: A non-math mental model of how dappTerminal fits together.
---

# System Overview

This page is a one-screen map of how dappTerminal fits together, with the math-heavy model intentionally omitted. The [next page](./algebraic-core.md) covers the formal command model.
...
The [Algebraic Core](./algebraic-core.md) page covers the fibered monoid specification — the formal mathematical model that underpins everything described above.
